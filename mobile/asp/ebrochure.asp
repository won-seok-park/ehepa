					...
					<div id="sub-bg">
						<div class="titleWrapper">
							<div class="title">
								<ul>
									<li><h1>e-브로슈어</h1></li>
									<li>한국BMS제약 간염 포트폴리오 관련 최신 문헌을 제공합니다.</li> 
								</ul>
							</div>
							<div class="line"></div>
						</div>
							...
							<div class="listWrapper">
								...
								<div class="list">
									<ul>
                                        ...
                                        %>
                                        <li>
											<%if len(acapic) > 0 then %><img src="/ufolder/academia/<%=acapic %>" /><%else %><img src="data/publication/01/publication.jpg" alt=""" /><%end if %>
                                            <ul>
                                        ...
                                        %>
                                        <li>
											<img src="data/publication/01/publication.jpg" alt="">
											<ul>
												<li class="color"></li>
												<li class="title">e-브로슈어 자료가 존재하지 않습니다.</li>
												<li></li>
												<li></li>
												<li></li>
											</ul>
