					...
					<div id="sub-bg">
						<div class="titleWrapper">
							<div class="title">
								<ul>
									<li><h1>지난 강의보기</h1></li>
									<li>e-conference에서 진행 되었던 간염 관련 최신 강의를 다시 보실 수 있습니다.</li> 
								</ul>
							</div>
							<div class="line"></div>
						</div>
							...
							<div class="listWrapper">
								...
								<div class="list">
									<ul>
                                        ...
                                        %>
                                        <li>
											<%if len(acapic) > 0 then %><img src="/ufolder/academia/<%=acapic %>" /><%else %><img src="data/old-lecture/01/lecture.jpg" alt=""" /><%end if %>
											<ul>
												<li class="color"><%=acasource %></li>
												<li class="title"><%=acatitle %></li>
												<li><%=acaauthor %></li>
												<li><%=acasdate %></li>
												
												<li class="btn"><a class="pop-lecture-1 grey button" href="http://play.wecandeo.com/video/v/?key=<%=AcaFile1%>" style="width:100%">영상보기</a></li>
											</ul>
										</li>
										<% 
                                            next
                                        ...
                                        <li>
											...
											<ul>
												<li class="color"></li>
												<li class="title">지난 강의보기 내용이 존재하지 않습니다.</li>
												<li></li>
												<li></li>
												<li></li>
											</ul>
