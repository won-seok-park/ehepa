				...
				<div id="wrapper">
					<div id="sub-bg">
						<div id="registerWrapper">
							...
							<div class="wrapper">
								<div class="text">
									변경이 모두 완료되었으면 수정 버튼을 클릭해주세요.
								</div>

                                <% 
                                uno = Request.Cookies("UNo")

                                msql = "select uemail,unm,upwd,umbl,uhosp,uaddr,uaddr2,uzip,upnob from ehepa_member_info where uno='" & UNo & "'"
                                ...
                                <div class="register">
									<ul>
										<li>
											ID(이메일)
											<input type="text" name="UNm" value="<%=uemail %>" style="width:100%;" placeholder="" disabled>
										</li>
										<li>
											이름
											<input type="text" name="UNm" value="<%=unm %>" style="width:100%;" placeholder="">
										</li>
										<li>
											비밀번호
											<input type="password" name="UPWD0" value="<%=upwd %>" style="width:100%;" placeholder="">
										</li>
										<li>
											비밀번호 확인
											<input type="password" name="UPWD1" value="" style="width:100%;" placeholder="">
										</li>
										<li class="aa">
											휴대폰
											<dl>
											<dd><select name="UMbl0" style="width:32%; margin-top:4px;">
												<option value="010" <%if umbls(0) = "010" then %>selected<%end if %>>010</option>
						                        <option value="011" <%if umbls(0) = "011" then %>selected<%end if %>>011</option>
                                                <option value="016" <%if umbls(0) = "016" then %>selected<%end if %>>016</option>
                                                <option value="019" <%if umbls(0) = "019" then %>selected<%end if %>>019</option>
											</select>
											<input type="text" name="UMbl1" class="" maxlength="4" value="<%=umbls(1) %>" style="width:32%" placeholder="" value="<%=umbls(1) %>" onkeydown='javascript:MaskMbl(this);'>
											<input type="text" name="UMbl2" class="" maxlength="4" value="<%=umbls(2) %>" style="width:32%" placeholder="" value="<%=umbls(1) %>" onkeydown='javascript:MaskMbl(this);'>
										...
										<li>
											인증번호
											<input type="text" name="UMbl_No" style="width:100%;" placeholder="휴대폰으로 받은 인증번호를 넣어주세요">
										</li>
										<li>
							                소속병원
							                <input type="text" name="UHosp" id="UHosp" value="<%=uhosp %>" style="width:100%;" placeholder="">
						                </li>
						                <li>
							                병원주소
                                        ...
                                        <li>
							                담당자코드(Optional)
							                <input type="text" name="UUpNo" id="UUpNo" maxlength="4" value="<%=upnob %>" style="width:100%;" placeholder="4자리 숫자인 담당자 코드를 넣어주세요." onkeydown='javascript:MaskMbl(this);'>
						                </li>
									</ul>
							...
							<div class="btn">
								<a href="javascript:goRegister();" class="green button">수정</a><a href="javascript:history.back();" class="grey button">취소</a>
							</div>
