...
<!--
    ...
    function goRegister() {
        ...
        var flag = window.confirm("기입하신 정보로 회원가입을 진행하시겠습니까?");

        if (flag) {
            form.action = "./register_ok.asp";
            form.submit();
        }
    }
			...
			<div class="wrapper">
                ...
                <div class="register">
					<ul>
						<li>
							ID(이메일)
							<input type="text" name="" value="<%=Request("UEmail") %>" style="width:100%;" placeholder="" disabled>
						</li>
						<li>
							이름
							<input type="text" name="UNm" style="width:100%;" placeholder="">
						</li>
						<li>
							비밀번호
						...
						<li class="aa">
							...
							<dl>
								<dd>
									<select name="UMbl0" style="width:32%; margin-top:4px;">
										<option value="010">010</option>
										<option value="011">011</option>
										<option value="016">016</option>
										<option value="019">019</option>
									</select>
									<input type="text" name="UMbl1" class="" maxlength="4" class="" style="width:32%" placeholder="" onkeydown='javascript:MaskMbl(this);'>
									<input type="text" name="UMbl2" class="" maxlength="4" class="" style="width:32%" placeholder="" onkeydown='javascript:MaskMbl(this);'>
						...
						<li>
							인증번호
							<input type="text" name="UMbl_No" style="width:100%;" placeholder="휴대폰으로 받은 인증번호를 넣어주세요." onkeydown='javascript:MaskMbl(this);'>
						</li>
						<li>
							소속병원
